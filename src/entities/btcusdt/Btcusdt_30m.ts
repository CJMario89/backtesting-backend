...
@Index('btcusdt_30m_pkey', ['id'], { unique: true })
@Index('btcusdt_30m_openTime_key', ['openTime'], { unique: true })
@Index('btcusdt_30m_openTime_idx', ['openTime'], {})
@Entity('btcusdt_30m', { schema: 'public' })
export class Btcusdt_30m {
