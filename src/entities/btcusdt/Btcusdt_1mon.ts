...
@Index('btcusdt_1mon_pkey', ['id'], { unique: true })
@Index('btcusdt_1mon_openTime_key', ['openTime'], { unique: true })
@Index('btcusdt_1mon_openTime_idx', ['openTime'], {})
@Entity('btcusdt_1mon', { schema: 'public' })
export class Btcusdt_1mon {
