...
@Index('btcusdt_12h_pkey', ['id'], { unique: true })
@Index('btcusdt_12h_openTime_key', ['openTime'], { unique: true })
@Index('btcusdt_12h_openTime_idx', ['openTime'], {})
@Entity('btcusdt_12h', { schema: 'public' })
export class Btcusdt_12h {
