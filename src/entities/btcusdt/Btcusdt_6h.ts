...
@Index('btcusdt_6h_pkey', ['id'], { unique: true })
@Index('btcusdt_6h_openTime_key', ['openTime'], { unique: true })
@Index('btcusdt_6h_openTime_idx', ['openTime'], {})
@Entity('btcusdt_6h', { schema: 'public' })
export class Btcusdt_6h {
