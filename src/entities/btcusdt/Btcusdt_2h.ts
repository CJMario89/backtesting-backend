...
@Index('btcusdt_2h_pkey', ['id'], { unique: true })
@Index('btcusdt_2h_openTime_key', ['openTime'], { unique: true })
@Index('btcusdt_2h_openTime_idx', ['openTime'], {})
@Entity('btcusdt_2h', { schema: 'public' })
export class Btcusdt_2h {
