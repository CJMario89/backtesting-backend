...
@Index('btcusdt_1d_pkey', ['id'], { unique: true })
@Index('btcusdt_1d_openTime_key', ['openTime'], { unique: true })
@Index('btcusdt_1d_openTime_idx', ['openTime'], {})
@Entity('btcusdt_1d', { schema: 'public' })
export class Btcusdt_1d {
