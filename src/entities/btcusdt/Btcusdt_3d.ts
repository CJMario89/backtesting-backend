...
@Index('btcusdt_3d_pkey', ['id'], { unique: true })
@Index('btcusdt_3d_openTime_key', ['openTime'], { unique: true })
@Index('btcusdt_3d_openTime_idx', ['openTime'], {})
@Entity('btcusdt_3d', { schema: 'public' })
export class Btcusdt_3d {
