...
@Index('btcusdt_1w_pkey', ['id'], { unique: true })
@Index('btcusdt_1w_openTime_key', ['openTime'], { unique: true })
@Index('btcusdt_1w_openTime_idx', ['openTime'], {})
@Entity('btcusdt_1w', { schema: 'public' })
export class Btcusdt_1w {
