...
@Index('btcusdt_1h_pkey', ['id'], { unique: true })
@Index('btcusdt_1h_openTime_key', ['openTime'], { unique: true })
@Index('btcusdt_1h_openTime_idx', ['openTime'], {})
@Entity('btcusdt_1h', { schema: 'public' })
export class Btcusdt_1h {
