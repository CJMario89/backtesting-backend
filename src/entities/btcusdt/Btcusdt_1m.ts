...
@Index('btcusdt_1m_pkey', ['id'], { unique: true })
@Index('btcusdt_1m_openTime_key', ['openTime'], { unique: true })
@Index('btcusdt_1m_openTime_idx', ['openTime'], {})
@Entity('btcusdt_1m', { schema: 'public' })
export class Btcusdt_1m {
