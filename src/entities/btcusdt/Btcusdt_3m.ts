...
@Index('btcusdt_3m_pkey', ['id'], { unique: true })
@Index('btcusdt_3m_openTime_key', ['openTime'], { unique: true })
@Index('btcusdt_3m_openTime_idx', ['openTime'], {})
@Entity('btcusdt_3m', { schema: 'public' })
export class Btcusdt_3m {
