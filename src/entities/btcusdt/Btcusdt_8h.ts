...
@Index('btcusdt_8h_pkey', ['id'], { unique: true })
@Index('btcusdt_8h_openTime_key', ['openTime'], { unique: true })
@Index('btcusdt_8h_openTime_idx', ['openTime'], {})
@Entity('btcusdt_8h', { schema: 'public' })
export class Btcusdt_8h {
